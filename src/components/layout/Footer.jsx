                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/shiv_urjapower?igsh=d2ozM2FocHBjemF4"
                                target="_blank"
                            ...
                            <span
                                title="LinkedIn"
                                className="w-10 h-10 rounded-full bg-industrial-100 border border-industrial-200 flex items-center justify-center text-industrial-600 transition-all duration-300 shadow-sm cursor-default"
                            >
